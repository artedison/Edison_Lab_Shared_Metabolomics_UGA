function specFit2rr0 = importSpecFit(filename, startRow, endRow)
%IMPORTFILE Import numeric data from a text file as a matrix.
%   SPECFIT2RR0 = IMPORTFILE(FILENAME) Reads data from text file FILENAME for the default
%   selection.
%
%   SPECFIT2RR0 = IMPORTFILE(FILENAME, STARTROW, ENDROW) Reads data from rows STARTROW
%   through ENDROW of text file FILENAME.
%
% Example:
%   specFit2rr0 = importfile('specFit_2_rr_0.txt', 2, 1575);
%
%    See also TEXTSCAN.

% Auto-generated by MATLAB on 2014/08/12 18:58:39
