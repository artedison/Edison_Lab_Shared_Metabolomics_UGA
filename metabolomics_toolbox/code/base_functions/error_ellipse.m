function ellipse=error_ellipse(varargin)
...
%    a vector whose length should match that of C (which is 2x2).
%
...
%
%   Notes, GSS:
%   Downloaded from: http://www.mathworks.com/matlabcentral/fileexchange/4705-error-ellipse
%   Stripped of all 3d capabilities, Now outputs the ellipse coordinates instead of
%   generating plots
...
k = sqrt(qchisq(conf,r)); % r is the number of dimensions (degrees of freedom)
    ...
    ellipse=[scale*(x0+k*x),scale*(y0+k*y)];
