...
% tight subplot @ https://www.mathworks.com/matlabcentral/fileexchange/30884-controllable-tight-subplot
localPaths.tight='/Users/yuewu/Dropbox (Edison_Lab@UGA)/Projects/Bioinformatics_modeling/matalb.lib/subplot_tight/';
%
addpath(genpath(localPaths.public_toolbox));
addpath(genpath(localPaths.fdalearn));
addpath(genpath(localPaths.fdam));
addpath(genpath(localPaths.tight));
%
