...
for samp_i_i=1:length(sample)
  ...
  objstr=complex_obj_func(mat,ppm,time',ridges,[-0.4 -0.2],10,[-0.4 10],regionsele,0.05);
...
for samp_i=1:4
  ...
  objstr=complex_obj_func(matrixstr{samp_i},ppm,times,ridges,[-0.4 -0.2],10,[-0.4 10],regionsele,0.05);
