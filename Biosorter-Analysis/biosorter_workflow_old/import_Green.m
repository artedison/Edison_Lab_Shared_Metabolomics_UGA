...
%   GREEN = IMPORTFILE(FILENAME) Reads data from text file FILENAME for the
%   default selection.
%
%   GREEN = IMPORTFILE(FILENAME, STARTROW, ENDROW) Reads data from rows
%   STARTROW through ENDROW of text file FILENAME.
%
% Example:
%   Green = importfile('MBC_03_D1.txt',2, 5305);
%
%    See also TEXTSCAN.

% Auto-generated by MATLAB on 2016/06/24 16:23:38
