function PCRed = import_PCRed(filename, startRow, endRow)
%IMPORTFILE Import numeric data from a text file as column vectors.
%   PCRED = IMPORTFILE(FILENAME) Reads data from text file FILENAME for the
%   default selection.
%
%   PCRED = IMPORTFILE(FILENAME, STARTROW, ENDROW) Reads data from rows
%   STARTROW through ENDROW of text file FILENAME.
%
% Example:
%   PCRed = importfile('MBC_03_D1.txt',2, 5305);
%
%    See also TEXTSCAN.

% Auto-generated by MATLAB on 2016/06/24 15:41:20
